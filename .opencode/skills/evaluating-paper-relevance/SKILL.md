...
description: "Two-stage paper screening - abstract scoring then deep dive for specific data extraction. Use after literature search returns results, when need to determine if paper contains specific data, when screening papers for relevance, or when extracting methods, results, data from papers."
---
