...
description: "Use Unpaywall API to find free full-text versions of paywalled papers. Use when paper is behind paywall, when PMC full text is not available, when DOI resolution hits a paywall, when you need free access to a paper, or before giving up on full text access."
---
