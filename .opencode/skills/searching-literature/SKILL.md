...
description: "PubMed search with keyword optimization, result parsing, and metadata extraction. Use when starting a literature search, when the user asks about papers, publications, or studies, when you need to find scientific articles, or when building an initial paper list for a research question."
---
