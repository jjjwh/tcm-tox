...
class MoleculeDataset(InMemoryDataset):
    def __init__(self, dataset, root, vocab_file_path=None):
        if vocab_file_path is None:
            vocab_file_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'datasets', 'vocab.txt')
        """
...
def create_all_datasets():
    ...
    for dataset_name in downstream_dir:
        ...
        root = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data', 'chem_dataset', dataset_name)
